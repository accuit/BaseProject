...
namespace AccuIT.CommonLayer.Aspects.Utilities
{
    ...
    /// <summary>
    /// Class to provide methods for config file details and other helper methods
    /// </summary>
    public static class AppUtil
    {
        ...
        /// <summary>
        /// Method to find distance between tow geo locations
        /// </summary>
        /// <param name="latitude1">latitude location 1</param>
        /// <param name="longitude1">longitude location 1</param>
        /// <param name="latitude2">latitude location 2</param>
        /// <param name="longitude2">longitude location 2</param>
        /// <returns></returns>
        public static double GetDistanceTo(double latitude1, double longitude1, double latitude2, double longitude2)
        {
            GeoCoordinate location1 = new GeoCoordinate(latitude1, longitude1);
            GeoCoordinate location2 = new GeoCoordinate(latitude2, longitude2);
